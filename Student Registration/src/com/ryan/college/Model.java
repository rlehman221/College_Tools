...
/**
 * Model's the ElonQueue being created along with popping out the registered students
 *
 * @author Ryan Lehman
 * 
 * @version 1.0
...
public class Model {
  ...
  /**
   * Scans through the data pulled and adds students to be put into a ElonQueue or an array list
   *
